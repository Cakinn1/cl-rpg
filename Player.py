...
class Player(Character):
    ...
    def __init__(self, strength=1,  dexterity=1, intelligence=1, xp=0, character_class=None):
        ...
        if character_class == self.MAGE_CLASS:
        ...
        elif character_class == self.WARRIOR_CLASS:
    ...
    def use_ability(self, enemy):
        ...
        while True:
            choice = input("Choose an ability (or 'b' to go back): ") 
    ...
    def level_up_anaimation(self):
        ...
        print(f"Here are your new stats: {self.view_stats}")
        print("##############################################")
        print("")
    ...
    def use_potion(self, potion_type):
        if potion_type in self.inventory:
